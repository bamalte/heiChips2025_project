...
`define NumVregisters 1 // (-1 for register 0, up to 8 -1 registers)
...
module Core (clk, reset, cycles, 
	...
	*/
	...
	//wire [`VLEN-1:0] c3_outA; wire [`VLEN-1:0] c3_outB; 
	//wire [2:0] c3_out_rd1; wire [2:0] c3_out_rd2; 
	wire c3_out_v; wire [31:0] c3_out;  wire [4:0] c3_out_rd; 
	
	C3_custom_instruction
	        c3 (clk, reset, c3_en&&!(halt), c_rd, /*c_rd1, c_rd2,*/ c_in, /*c_inA, c_inB,*/ 
    		c3_out_v, c3_out_rd, /*c3_out_rd1, c3_out_rd2,*/ c3_out,
    		/*, c3_outA, c3_outB*/ c3_not_accepting);
